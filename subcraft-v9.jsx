...
const GS = () => (
  <style>{`
    @import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600;9..40,700&family=JetBrains+Mono:wght@400;500;700&family=Space+Grotesk:wght@300;400;500;600;700&display=swap');
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    html{scroll-behavior:smooth}
    body{background:#02030a;color:#f0f2ff;font-family:'Space Grotesk','DM Sans',sans-serif;min-height:100vh;overflow-x:hidden}
    ...
    @media(max-width:768px){
      ...
      .mobile-p2{padding:10px!important}
      ...
      h1.hero-title{font-size:clamp(30px,9vw,56px)!important;letter-spacing:-.03em!important}
    }
    ...
    /* Editor mobile: right panel takes full screen */
    @media(max-width:768px){
...
const SUBTITLE_STYLES=[
  ...
  {id:"double-outline",label:"Double Outline",badge:"TikTok",preview:{bg:"transparent",color:"#fff",font:"Impact",weight:900,size:66,shadow:"3px 3px 0 #ff4f8a,-3px -3px 0 #ff4f8a,0 0 40px rgba(255,79,138,.5)",transform:"uppercase"}},
  ...
  {id:"fire-gradient",label:"Fire Gradient",badge:"Reels",preview:{bg:"transparent",color:"#ff7043",font:"Outfit",weight:900,size:62,shadow:"0 0 20px #ff7043,0 0 40px #ff703399,3px 3px 0 #000",transform:"uppercase"}},
  {id:"cyan-punch",label:"Cyan Punch",badge:"Gaming",preview:{bg:"transparent",color:"#00d4ff",font:"Outfit",weight:900,size:62,shadow:"0 0 18px #00d4ff,0 0 36px #00d4ff66,2px 2px 0 #000",transform:"uppercase"}},
  {id:"black-yellow",label:"Black & Yellow",preview:{bg:"rgba(0,0,0,.9)",color:"#FFE600",font:"Impact",weight:900,size:58,shadow:"none",transform:"uppercase"}},
  {id:"lena-sit",label:"Léna Situations",badge:"FR",preview:{bg:"rgba(255,79,138,.92)",color:"#fff",font:"Outfit",weight:900,size:50,shadow:"none",transform:"none"}},
  ...
  {id:"stroke-white",label:"Stroke Clean",preview:{bg:"transparent",color:"#fff",font:"Outfit",weight:900,size:60,shadow:"-2px -2px 0 #000,2px -2px 0 #000,-2px 2px 0 #000,2px 2px 0 #000",transform:"none"}},
  {id:"horror",label:"Horror",badge:"Creepy",preview:{bg:"transparent",color:"#ff3b5c",font:"Impact",weight:900,size:64,shadow:"0 0 20px #ff3b5c,0 0 60px #ff3b5c88,4px 0 0 #000,-4px 0 0 #000",transform:"uppercase"}},
  {id:"neon-blue-pulse",label:"Neon Blue",badge:"Cyber",preview:{bg:"transparent",color:"#4f6dff",font:"Outfit",weight:900,size:62,shadow:"0 0 10px #4f6dff,0 0 30px #4f6dff,0 0 60px #4f6dff66",transform:"uppercase"}},
  {id:"gold-luxury",label:"Gold Luxury",badge:"Business",preview:{bg:"transparent",color:"#ffd700",font:"Outfit",weight:900,size:58,shadow:"0 0 20px #ffd70099,2px 2px 0 #7c4f00",transform:"uppercase"}},
  ...
  {id:"white-blue-card",label:"White Card Blue",preview:{bg:"rgba(12,18,48,.93)",color:"#fff",font:"Outfit",weight:800,size:50,shadow:"none",transform:"none"}},
  {id:"pop-orange",label:"Pop Orange",preview:{bg:"transparent",color:"#ff7043",font:"Outfit",weight:900,size:64,shadow:"3px 3px 0 #000,-1px -1px 0 #000",transform:"uppercase"}},
  {id:"gradient-text",label:"Gradient Vibe",preview:{bg:"transparent",color:"#9c6dff",font:"Outfit",weight:900,size:58,shadow:"0 0 30px #9c6dff66,2px 2px 0 #000",transform:"uppercase"}},
];
...
/* ── PHONE MOCKUP ── */
const PhoneMockup=({subs,currentTime,styleId,fontSize,fontFamily,playing,onToggle,liveStyle})=>{
    ...
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:10,flexShrink:0}}>
      <div style={{width:W,height:H,borderRadius:42,background:"linear-gradient(160deg,#070a1c,#040611)",border:"2.5px solid rgba(91,108,255,.25)",boxShadow:"0 0 0 1px rgba(255,255,255,.04),0 40px 80px rgba(0,0,0,.8),0 0 80px rgba(91,108,255,.12),inset 0 1px 0 rgba(255,255,255,.07)",position:"relative",overflow:"hidden",flexShrink:0}}>
        ...
        <div style={{width:"100%",height:"100%",background:"linear-gradient(180deg,#121a38 0%,#070812 55%,#080318 100%)",position:"relative",display:"flex",alignItems:"center",justifyContent:"center"}}>
          ...
          {/* SUBTITLE OVERLAY */}
          {active&&(
            <div key={active.id} style={{position:"absolute",bottom:"16%",left:0,right:0,textAlign:"center",padding:"0 8px",zIndex:10,display:"flex",justifyContent:"center",alignItems:"center"}}>
              <span style={subStyle}>{active.text}</span>
            </div>
          )}
          {!active&&(
            <div style={{position:"absolute",bottom:"16%",left:0,right:0,textAlign:"center",padding:"0 8px",zIndex:10,opacity:.18,display:"flex",justifyContent:"center"}}>
...
const LoginPage=({onAuth,onAdmin,goSignup})=>{
  ...
  return(
    <div style={{minHeight:"100vh",display:"flex",background:T.bg,position:"relative",overflow:"hidden"}} className="mobile-col page">
      ...
      {/* RIGTTC — FORM */}
      <div style={{width:"100%",maxWidth:480,display:"flex",alignItems:"center",justifyContent:"center",padding:40,position:"relative",zIndex:1,borderLeft:"1px solid rgba(255,255,255,.04)"}} className="mobile-p">
...
/* ══ LANDING PAGE ══ */
const LandingPage=({onCTA,setPage,goCheckout})=>{
  ...
  return(
    <div style={{background:T.bg,minHeight:"100vh",position:"relative",overflow:"hidden"}}>
      ...
      {/* NAV — clean glass pill */}
      <nav style={{position:"sticky",top:0,zIndex:100,height:60,padding:"0 32px",display:"flex",alignItems:"center",gap:10,backdropFilter:"blur(40px)",background:"rgba(2,3,10,.78)",borderBottom:"1px solid rgba(255,255,255,.04)"}} className="mobile-p">
        {/* Logo */}
        <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0}}>
          <div style={{width:30,height:30,borderRadius:9,background:T.grad,display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,boxShadow:`0 0 18px ${T.accGlow}`}}>✦</div>
          <span className="syne grad-text-chrome" style={{fontWeight:800,fontSize:16,letterSpacing:"-.025em"}}>SubCraft</span>
        </div>
        {/* Center links */}
        <div style={{flex:1,display:"flex",justifyContent:"center",gap:0}} className="hide-mobile">
          {[["Fonctionnalités","fonctionnalités"],["Comment ça marche","comment"],["Exemples","exemples"],["Tarifs","tarifs"]].map(([l,id])=>(
            <button key={l} onClick={()=>document.getElementById(id)?.scrollIntoView({behavior:"smooth"})} style={{padding:"7px 14px",borderRadius:8,background:"transparent",border:"none",color:T.muted,fontSize:12.5,fontWeight:500,cursor:"pointer",transition:"color .15s",whiteSpace:"nowrap"}}
        ...
        <div style={{display:"flex",gap:8,marginLeft:"auto",alignItems:"center"}}>
          <button onClick={()=>setPage("auth")} className="hide-mobile" style={{padding:"7px 16px",borderRadius:9,background:"transparent",border:"1px solid rgba(255,255,255,.09)",color:T.muted,fontSize:12.5,cursor:"pointer",transition:"all .2s"}}
            onMouseEnter={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,.18)";e.currentTarget.style.color=T.text;}}
            onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,.09)";e.currentTarget.style.color=T.muted;}}>
            Connexion
          </button>
          <button onClick={onCTA} className="shimmer-btn" style={{padding:"8px 20px",borderRadius:10,background:T.grad,border:"none",color:"#fff",fontSize:13,fontWeight:700,cursor:"pointer",boxShadow:`0 4px 20px ${T.accGlow}`,transition:"all .2s"}}
            onMouseEnter={e=>{e.currentTarget.style.transform="scale(1.04)";e.currentTarget.style.boxShadow=`0 8px 32px ${T.accGlow}`;}}
            onMouseLeave={e=>{e.currentTarget.style.transform="none";e.currentTarget.style.boxShadow=`0 4px 20px ${T.accGlow}`;}}>
            Commencer gratuit →
          </button>
        </div>
      </nav>
      ...
      {/* HERO */}
      <div ref={heroRef} id="fonctionnalités" style={{position:"relative",zIndex:1,display:"flex",alignItems:"center",padding:"60px 72px 48px",maxWidth:1400,margin:"0 auto",gap:60,minHeight:"85vh"}} className="mobile-col mobile-p">
        {/* LEFT: Text */}
        <div style={{flex:1,minWidth:0}}>
          {/* Badge */}
          <div className="fu" style={{display:"inline-flex",alignItems:"center",gap:8,padding:"6px 16px",borderRadius:100,background:"rgba(52,211,153,.07)",border:"1px solid rgba(52,211,153,.22)",marginBottom:36,boxShadow:"0 0 20px rgba(52,211,153,.08)"}}>
          ...
          <h1 className="fu syne text-3d" style={{fontWeight:800,fontSize:"clamp(52px,6vw,96px)",lineHeight:.96,letterSpacing:"-.058em",marginBottom:28,animationDelay:".06s"}}>
            ...
            <span className="grad-text-aurora" style={{display:"block",backgroundSize:"300%",animation:"gradShift 5s linear infinite"}}>qui explosent</span>
          ...
          {/* Description */}
          <p className="fu" style={{fontSize:16,color:"rgba(180,185,220,.85)",maxWidth:480,lineHeight:1.85,marginBottom:44,animationDelay:".12s"}}>
            Colle ton lien TikTok ou YouTube, l'IA transcrit en <strong style={{color:T.text,fontWeight:700}}>10 secondes</strong>. Choisis parmi <strong style={{color:T.text,fontWeight:700}}>24 styles viraux</strong>. Exporte en HD.
          </p>
          {/* CTAs */}
          <div className="fu" style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:52,animationDelay:".17s"}}>
            <button onClick={onCTA} className="shimmer-btn" style={{display:"flex",alignItems:"center",gap:10,padding:"15px 32px",borderRadius:16,background:T.grad,border:"none",color:"#fff",fontSize:15,fontWeight:700,cursor:"pointer",boxShadow:`0 8px 48px ${T.accGlow},0 0 100px ${T.acc}22,inset 0 1px 0 rgba(255,255,255,.15)`,transition:"all .3s",letterSpacing:"-.02em"}}
              onMouseEnter={e=>{e.currentTarget.style.transform="translateY(-3px) scale(1.03)";e.currentTarget.style.boxShadow=`0 16px 60px ${T.accGlow},0 0 120px ${T.acc}33`;}}
              onMouseLeave={e=>{e.currentTarget.style.transform="none";e.currentTarget.style.boxShadow=`0 8px 48px ${T.accGlow},0 0 100px ${T.acc}22,inset 0 1px 0 rgba(255,255,255,.15)`;}}>
              <span style={{fontSize:18}}>✦</span> Générer mes sous-titres — Gratuit
            </button>
            <button onClick={()=>document.getElementById("exemples")?.scrollIntoView({behavior:"smooth"})} style={{display:"flex",alignItems:"center",gap:8,padding:"15px 26px",borderRadius:16,background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.1)",color:T.text,fontSize:15,cursor:"pointer",transition:"all .3s",backdropFilter:"blur(16px)"}}
              onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.2)";}}
              onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.03)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
              ▶ Voir les exemples
            </button>
          </div>
          {/* Stats */}
          <div className="fu" style={{display:"flex",gap:0,animationDelay:".22s",background:"rgba(255,255,255,.025)",borderRadius:16,border:"1px solid rgba(255,255,255,.05)",overflow:"hidden",maxWidth:420}}>
            {[["10k+","Créateurs"],["99%","Précision IA"],["<10s","Génération"],["24","Styles"]].map(([v,l],i)=>(
              <div key={l} style={{flex:1,padding:"14px 12px",textAlign:"center",borderRight:i<3?"1px solid rgba(255,255,255,.05)":"none"}}>
                <div className="syne" style={{fontWeight:800,fontSize:20,background:T.grad,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",lineHeight:1}}>{v}</div>
                <div style={{fontSize:9,color:T.muted,marginTop:3,letterSpacing:".04em",textTransform:"uppercase"}}>{l}</div>
              </div>
            ))}
          </div>
        </div>

        {/* RIGHT: 3D Phone — full-screen video, large */}
        <div className="fu hide-mobile" style={{flexShrink:0,animationDelay:".06s",position:"relative",display:"flex",alignItems:"center",justifyContent:"center"}}>
          {/* Deep glow halo */}
          <div style={{position:"absolute",inset:-80,background:`radial-gradient(${T.acc}20 0%,${T.purple}08 45%,transparent 70%)`,filter:"blur(50px)",pointerEvents:"none",animation:"glowPulse 4s ease infinite"}}/>
          {/* Floating stat bubbles */}
          <div style={{position:"absolute",top:"8%",left:"-24%",padding:"8px 14px",borderRadius:14,background:"rgba(10,12,26,.92)",border:"1px solid rgba(255,255,255,.08)",backdropFilter:"blur(16px)",boxShadow:"0 8px 32px rgba(0,0,0,.4)",animation:"float 5s ease infinite",whiteSpace:"nowrap"}}>
            <div style={{fontSize:9,color:T.muted,marginBottom:2,letterSpacing:".04em",textTransform:"uppercase"}}>Générés aujourd'hui</div>
            <div className="syne" style={{fontWeight:800,fontSize:18,color:T.green}}>+2,841</div>
            <div style={{fontSize:9,color:T.muted,marginTop:1}}>sous-titres créés 🎬</div>
          </div>
          <div style={{position:"absolute",bottom:"20%",left:"-28%",padding:"8px 14px",borderRadius:14,background:"rgba(10,12,26,.92)",border:"1px solid rgba(255,255,255,.08)",backdropFilter:"blur(16px)",boxShadow:"0 8px 32px rgba(0,0,0,.4)",animation:"float 6.5s ease infinite",animationDelay:".8s",whiteSpace:"nowrap"}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              ...
              <div>
                <div style={{fontSize:11,fontWeight:700}}>MrBeast Style</div>
                <div style={{fontSize:9,color:T.green,fontWeight:600}}>⭐ Style #1 populaire</div>
              </div>
            </div>
          </div>
          <div style={{position:"absolute",top:"28%",right:"-22%",padding:"8px 14px",borderRadius:14,background:"rgba(10,12,26,.92)",border:"1px solid rgba(255,255,255,.08)",backdropFilter:"blur(16px)",boxShadow:"0 8px 32px rgba(0,0,0,.4)",animation:"float 7s ease infinite",animationDelay:"1.2s",whiteSpace:"nowrap"}}>
            <div style={{fontSize:9,color:T.muted,marginBottom:3,textTransform:"uppercase",letterSpacing:".04em"}}>Précision IA</div>
            <div className="syne" style={{fontWeight:800,fontSize:18,color:T.acc}}>99.2%</div>
            <div style={{height:3,borderRadius:2,background:"rgba(255,255,255,.06)",marginTop:4,overflow:"hidden"}}>
              <div style={{height:"100%",width:"99%",background:`linear-gradient(90deg,${T.acc},${T.purple})`,borderRadius:2}}/>
            </div>
          </div>
          <div style={{position:"absolute",bottom:"8%",right:"-18%",padding:"8px 12px",borderRadius:12,background:"rgba(10,12,26,.92)",border:`1px solid ${T.green}25`,backdropFilter:"blur(16px)",animation:"float 4.5s ease infinite",animationDelay:"2s",whiteSpace:"nowrap"}}>
            <div style={{display:"flex",alignItems:"center",gap:6}}>
              <span style={{width:6,height:6,borderRadius:"50%",background:T.green,animation:"pulseDotGreen 2s infinite"}}/>
              <span style={{fontSize:11,fontWeight:700,color:T.green}}>+12k créateurs actifs</span>
            </div>
          </div>
          {/* Mouse-tracking 3D wrapper */}
          <div style={{transform:`perspective(1600px) rotateY(${mouse.x*10}deg) rotateX(${-mouse.y*6}deg)`,transition:"transform .08s ease-out",transformStyle:"preserve-3d",position:"relative",zIndex:1}}>
            <Phone3D size="large"/>
            {/* Orbiting icons */}
            <div style={{position:"absolute",top:"50%",left:"50%",width:0,height:0,pointerEvents:"none"}}>
              <div style={{position:"absolute",width:46,height:46,borderRadius:13,background:"rgba(91,108,255,.15)",border:"1px solid rgba(91,108,255,.35)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,animation:"orbit 9s linear infinite",boxShadow:`0 0 24px rgba(91,108,255,.3)`}}>⚡</div>
              <div style={{position:"absolute",width:40,height:40,borderRadius:11,background:"rgba(168,85,247,.14)",border:"1px solid rgba(168,85,247,.35)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,animation:"orbit2 14s linear infinite"}}>🎨</div>
              <div style={{position:"absolute",width:36,height:36,borderRadius:10,background:"rgba(52,211,153,.12)",border:"1px solid rgba(52,211,153,.3)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,animation:"orbit3 7s linear infinite"}}>✓</div>
            </div>
          </div>
          {/* Ground shadow */}
          <div style={{position:"absolute",bottom:-60,left:"50%",transform:"translateX(-50%)",width:280,height:60,background:`radial-gradient(${T.acc}28,transparent 70%)`,filter:"blur(30px)",pointerEvents:"none"}}/>
        </div>
      </div>
      ...
      <div id="tarifs" style={{position:"relative",zIndex:1,maxWidth:1060,margin:"0 auto 140px",padding:"0 48px"}} className="mobile-p">
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12}} className="mobile-grid1">
          {PLANS.map((plan,i)=>(
            <div key={plan.id} style={{borderRadius:22,background:plan.popular?"linear-gradient(145deg,rgba(91,108,255,.1),rgba(168,85,247,.07))":T.surf,border:plan.popular?"1px solid rgba(91,108,255,.38)":"1px solid rgba(255,255,255,.055)",padding:"26px 20px",position:"relative",overflow:"hidden",transition:"all .3s",boxShadow:plan.popular?"0 0 60px rgba(91,108,255,.12)":"none",animation:`fadeUp .4s ${i*.07}s both`}} onMouseEnter={e=>{e.currentTarget.style.transform="perspective(600px) translateY(-6px) rotateX(2deg)";e.currentTarget.style.boxShadow=`0 24px 60px rgba(0,0,0,.5),0 0 0 1px rgba(255,255,255,.08)`;}} onMouseLeave={e=>{e.currentTarget.style.transform="perspective(600px) translateY(0) rotateX(0)";e.currentTarget.style.boxShadow="none";}}>
              ...
              <div style={{position:"relative",zIndex:1}}>
                ...
                {billingY&&plan.price>0&&<div style={{fontSize:11,marginBottom:14,display:"flex",alignItems:"center",gap:6}}><span style={{color:T.green,fontWeight:700}}>€{plan.priceY*12}/an</span><span style={{color:T.muted,fontSize:10}}>TVA incluse</span></div>}
                ...
                <button onClick={()=>plan.id==="free"?onCTA():(goCheckout?goCheckout(plan.id,billingY):setPage("pricing"))} className={plan.popular?"shimmer-btn":""} style={{width:"100%",padding:"11px",borderRadius:11,background:plan.popular?T.grad:"rgba(255,255,255,.055)",border:plan.popular?"none":"1px solid rgba(255,255,255,.09)",color:"#fff",fontSize:13,fontWeight:700,cursor:"pointer",transition:"all .2s"}} onMouseEnter={e=>e.currentTarget.style.opacity=".85"} onMouseLeave={e=>e.currentTarget.style.opacity="1"}>{plan.id==="free"?"Commencer gratuit":"Choisir ce plan"}</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{position:"relative",zIndex:1,textAlign:"center",padding:"80px 48px 110px",maxWidth:780,margin:"0 auto"}} className="mobile-p">
        ...
        <div style={{position:"relative"}}>
          <h2 className="syne" style={{fontWeight:800,fontSize:"clamp(34px,5vw,62px)",letterSpacing:"-.045em",marginBottom:20}}>Prêt à faire <span className="grad-text">exploser tes vues</span> ?</h2>
...
const Dashboard=({user,setUser,onOpen,onLogout,setPage})=>{
  ...
  const userFiles=useMemo(()=>MOCK_FILES.map(f=>({...f,ownerId:user?.email})),[user?.email]);
  ...
  return(
    <div style={{minHeight:"100vh",background:T.bg,position:"relative"}} className="page"><AuroraBg subtle/><Cursor/>
      {/* NAV */}
      <nav style={{padding:"0 24px",borderBottom:"1px solid rgba(255,255,255,.04)",display:"flex",alignItems:"center",gap:8,background:"rgba(2,3,10,.92)",backdropFilter:"blur(40px)",height:58,position:"sticky",top:0,zIndex:50}}>
        {/* Logo */}
        <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0}}>
          <div style={{width:28,height:28,borderRadius:8,background:T.grad,display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,boxShadow:`0 0 16px ${T.accGlow}`}}>✦</div>
          <span className="syne grad-text-chrome" style={{fontWeight:800,fontSize:15,letterSpacing:"-.025em"}}>SubCraft</span>
        </div>
        {/* Nav pills — compact */}
        <div style={{display:"flex",gap:1,marginLeft:8}} className="hide-mobile">
          {[["Mes vidéos",null,"🎬"],["Templates","templates","🎨"],["Abonnement","subscription","💳"]].map(([label,target,ic])=>(
            <button key={label} onClick={()=>target&&setPage(target)} style={{padding:"5px 11px",borderRadius:8,background:"transparent",border:"none",color:T.muted,fontSize:12,cursor:"pointer",display:"flex",alignItems:"center",gap:4,transition:"all .15s"}}
              onMouseEnter={e=>{e.currentTarget.style.background=`${T.acc}0e`;e.currentTarget.style.color=T.text;}}
      ...
      <div style={{maxWidth:960,margin:"0 auto",padding:"24px 20px",position:"relative",zIndex:1}} className="mobile-p">
            ...
            <div style={{display:"flex",gap:7,alignItems:"center",paddingTop:4}} className="mobile-full-btn">
              <button onClick={()=>setPage("templates")}
                style={{padding:"8px 14px",borderRadius:9,background:"rgba(255,255,255,.05)",
                  border:"1px solid rgba(255,255,255,.09)",color:T.muted,fontSize:12,cursor:"pointer",
              ...
              <button onClick={()=>setShowUpload(true)}
                style={{display:"flex",alignItems:"center",gap:7,padding:"9px 20px",
                  borderRadius:10,background:T.grad,border:"none",color:"#fff",
                  fontSize:13,fontWeight:700,cursor:"pointer",
                  boxShadow:`0 4px 18px ${T.accGlow}`,transition:"all .18s"}}
                onMouseEnter={e=>{e.currentTarget.style.transform="translateY(-2px)";e.currentTarget.style.boxShadow=`0 8px 28px ${T.accGlow}`;}}
                onMouseLeave={e=>{e.currentTarget.style.transform="none";e.currentTarget.style.boxShadow=`0 4px 18px ${T.accGlow}`;}}>
        ...
        {(creditWarn||user?.plan==="Free")&&(
          <div style={{padding:"14px 20px",borderRadius:16,background:creditWarn?`linear-gradient(135deg,${T.orange}12,${T.yellow}06)`:`linear-gradient(135deg,${T.acc}10,${T.purple}06)`,border:`1px solid ${creditWarn?T.orange:T.acc}30`,marginBottom:16,display:"flex",alignItems:"center",gap:16,flexWrap:"wrap"}}>
            ...
            <div style={{flex:1,minWidth:160}}>
              <div style={{fontWeight:700,fontSize:13,marginBottom:2}}>{creditWarn?"Crédits presque épuisés":"Plan gratuit — 3 vidéos max"}</div>
        ...
        {/* ── FILES SECTION ── */}
        <div style={{background:`linear-gradient(145deg,${T.surf},${T.surf2})`,borderRadius:16,border:"1px solid rgba(255,255,255,.065)",overflow:"hidden",boxShadow:"0 8px 40px rgba(0,0,0,.3)"}}>
          {/* Section header */}
                ...
                return(
                  <div key={f.id}
                    ...
                    <div style={{display:"flex",gap:5,flexShrink:0}} onClick={e=>e.stopPropagation()}>
                      ...
                      <button onClick={()=>{if(window.confirm("Supprimer ?"))setFiles(p=>p.filter(x=>x.id!==f.id));}}
...
const EditorPage=({onBack,file})=>{
  ...
  const liveSubStyle={
    ...
    display:"inline-block",
    lineHeight:1.25,
    // ← Always allow wrapping + center — this was the bug
    maxWidth:"90%",
    whiteSpace:"normal",
    wordBreak:"break-word",
    textAlign:"center",
    ...
    animation:hasEff("MrBeast flash")?"subtitlePop .15s cubic-bezier(.34,1.56,.64,1) both":
              ...
              "subtitlePop .22s cubic-bezier(.34,1.56,.64,1) both",
  };
  ...
  return(
    <div style={{height:"100vh",display:"flex",flexDirection:"column",background:T.bg,overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"grid",gridTemplateColumns:"320px 1fr",overflow:"hidden"}} className="editor-grid">
        {/* LEFT: Phone preview */}
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:16,borderRight:`1px solid rgba(255,255,255,.05)`,background:"linear-gradient(180deg,#02030f,#040510)",overflowY:"auto",padding:"20px 16px",position:"relative"}} className="hide-mobile">
          {/* Ambient glow behind phone */}
          <div style={{position:"absolute",top:"30%",left:"50%",transform:"translateX(-50%)",width:260,height:260,borderRadius:"50%",background:`radial-gradient(${T.acc}20,transparent 70%)`,filter:"blur(50px)",pointerEvents:"none"}}/>
          {/* 3D phone mockup — glowing, floating */}
          <div style={{position:"relative",zIndex:1,transition:"transform .3s cubic-bezier(.22,1,.36,1)",animation:"float3d 5s ease infinite"}}
            ...
            <PhoneMockup subs={subs} currentTime={ct} styleId={styleId} fontSize={fontSize} fontFamily={fontFam} playing={playing} onToggle={()=>setPlaying(p=>!p)} liveStyle={liveSubStyle}/>
          </div>
          {/* Play controls */}
          <div style={{display:"flex",gap:8,alignItems:"center",position:"relative",zIndex:1}}>
            <button onClick={()=>setCt(0)} style={{width:32,height:32,borderRadius:9,background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.08)",color:T.muted,fontSize:12,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}>⏮</button>
            <button onClick={()=>setPlaying(p=>!p)} style={{width:44,height:44,borderRadius:12,background:T.grad,border:"none",color:"#fff",fontSize:16,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:`0 4px 20px ${T.accGlow}`}}>
              {playing?"⏸":"▶"}
            </button>
            <button onClick={()=>setShowExport(true)} style={{width:32,height:32,borderRadius:9,background:`${T.acc}15`,border:`1px solid ${T.acc}30`,color:T.acc,fontSize:12,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}>⬆</button>
          </div>
          {/* Active style badge */}
          <div style={{position:"relative",zIndex:1,padding:"6px 14px",borderRadius:100,background:`${T.acc}10`,border:`1px solid ${T.acc}20`,fontSize:11,color:T.acc,fontWeight:600}}>
            ✦ {activeStyle.label}
          </div>
        </div>
        ...
        <div style={{display:"flex",flexDirection:"column",overflow:"hidden",background:T.bg}}>
          ...
          <div style={{flex:1,overflowY:"auto",padding:18,scrollbarWidth:"thin"}}>

            {/* CAPTIONS */}
            {tab==="captions"&&(
              <div style={{display:"flex",flexDirection:"column",gap:6}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12,padding:"10px 14px",borderRadius:12,background:`${T.acc}06`,border:`1px solid ${T.acc}18`}}>
                  <div>
                    <span style={{fontSize:13,fontWeight:700,color:T.text}}>{subs.length} sous-titres</span>
                    <span style={{fontSize:10,color:T.muted,marginLeft:8}}>Clique sur un mot pour éditer</span>
                  </div>
                          ...
                          <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                            <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                              {sub.text.split(" ").map((w,wi)=>(
                                <span key={wi} onClick={()=>{setEditId(sub.id);setEditTxt(sub.text);}} style={{padding:"3px 9px",borderRadius:6,background:T.surf2,border:`1px solid rgba(255,255,255,.07)`,fontSize:12,fontWeight:500,cursor:"text",transition:"all .15s",letterSpacing:"-.01em"}}
                                  onMouseEnter={e=>{e.currentTarget.style.borderColor=T.acc+"60";e.currentTarget.style.color=T.acc;e.currentTarget.style.background=`${T.acc}12`;}}
                                  onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,.07)";e.currentTarget.style.color=T.text;e.currentTarget.style.background=T.surf2;}}>{w}</span>
                              ))}
                            </div>
                          </div>
                        )}
              ...
              <div style={{display:"flex",flexDirection:"column",gap:16}}>
                ...
                {footageType!=="upload"&&(
                  <div>
                    ...
                    <div style={{position:"relative"}}>
                      <input value={footageUrl} onChange={e=>setFootageUrl(e.target.value)} placeholder={footageType==="youtube"?"https://youtu.be/...":"https://tiktok.com/@..."} style={{width:"100%",padding:"10px 14px",borderRadius:10,fontSize:13,background:T.bg,border:`1px solid ${footageUrl?T.acc:T.border}`,color:T.text,fontFamily:"JetBrains Mono",fontSize:11,transition:"border .2s"}}/>
                    </div>
                    {footageUrl&&(
                ...
                <div style={{position:"relative",zIndex:1}}>
                  ...
                  {yearly&&price>0&&(
                    <div style={{fontSize:11,marginBottom:20,display:"flex",alignItems:"center",gap:6}}>
                      <span style={{padding:"3px 8px",borderRadius:6,background:`${T.green}15`,color:T.green,fontWeight:700}}>💰 Économise €{(plan.price-plan.priceY)*12}/an</span>
                  ...
                  {price>0?(
                    ...
                    <button onClick={()=>onSelect?.("free",yearly)} style={{width:"100%",padding:"12px",borderRadius:12,background:"transparent",border:`1px solid rgba(255,255,255,.1)`,color:T.muted,fontSize:13,fontWeight:600,cursor:"pointer",marginBottom:22}}>Gratuit pour toujours</button>
                  )}
  ...
  return(
    <div style={{minHeight:"100vh",display:"flex",background:"#010208",position:"relative"}}>
          ...
          <div className="page">
            ...
            <div style={{display:"grid",gap:12}}>
              {[
                ...
                {ok:false,title:"Credentials admin en dur ⚠️",desc:"admin@subcraftai.com / admin123 — À CHANGER avant production. Utiliser un hash bcrypt en base de données ou OAuth2."},
        ...
        {view==="dashboard"&&(
          <div className="page">
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(185px,1fr))",gap:10,marginBottom:24}} className="mobile-grid1">
              {[
                {icon:"👥",label:"Utilisateurs",value:users.length,color:T.acc,trend:"+3",sub:"ce mois"},
                {icon:"💰",label:"MRR",value:`€${totalMRR}`,color:T.green,trend:"+12%",sub:"revenus mensuels"},
                {icon:"⭐",label:"Plan Pro",value:users.filter(u=>u.plan==="Pro").length,color:T.purple,trend:"+2",sub:`${Math.round(users.filter(u=>u.plan==="Pro").length/users.length*100)}% des users`},
                {icon:"🎬",label:"Vidéos",value:users.reduce((a,u)=>a+u.videos,0),color:T.cyan,trend:"+18%",sub:"traitées total"},
                {icon:"🔴",label:"Suspendus",value:users.filter(u=>u.status==="suspended").length,color:T.pink,trend:"⚠",sub:"à traiter"},
                {icon:"🆕",label:"Trials",value:users.filter(u=>u.status==="trial").length,color:T.yellow,trend:"→",sub:"conversion possible"},
              ].map((s,i)=>(
      ...
      {showAdd&&(
        ...
        </div>{/* closes <div style={{padding:28}}> */}
      </div>{/* closes <div style={{flex:1,overflowY:"auto"}}> */}
    </div>
  );
};
...
export default function App(){
  ...
  return(
    <>
      ...
      {page==="landing"&&<LandingPage onCTA={()=>nav("signup")} setPage={nav} goCheckout={goCheckout}/>}
