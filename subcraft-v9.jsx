  ...
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    @media(max-width:768px){
      ...
      h1{font-size:clamp(36px,8vw,82px)!important}
    }
...
const LandingPage=({onCTA,setPage,goCheckout})=>{
  ...
  return(
    <div style={{background:T.bg,minHeight:"100vh",position:"relative",overflow:"hidden"}}>
      ...
      {/* HERO */}
      <div ref={heroRef} id="fonctionnalités" style={{position:"relative",zIndex:1,display:"flex",alignItems:"center",padding:"72px 80px 60px",maxWidth:1400,margin:"0 auto",gap:60,minHeight:"90vh"}} className="mobile-col mobile-p">
        {/* LEFT: Text */}
  ...
  return(
    <div style={{minHeight:"100vh",background:T.bg,position:"relative"}} className="page"><AuroraBg subtle/><Cursor/>
      ...
      <div style={{maxWidth:960,margin:"0 auto",padding:"32px 24px",position:"relative",zIndex:1}}>
        ...
        <div style={{marginBottom:20}}>
          ...
          {files.filter(f=>f.status==="ready").length<3&&(
            <div style={{display:"flex",gap:8,padding:"12px 14px",borderRadius:14,background:"linear-gradient(135deg,rgba(91,108,255,.06),rgba(168,85,247,.04))",border:"1px solid rgba(91,108,255,.12)",flexWrap:"wrap"}}>
              {[["1","📤","Importe ta vidéo","MP4, MOV, URL YouTube"],["2","🤖","L'IA génère tes subs","Whisper AI · 10 secondes"],["3","🎨","Choisis ton style","MrBeast, Squeezie, +22 styles"],].map(([n,ic,t,s])=>(
                <div key={n} style={{display:"flex",alignItems:"center",gap:8,flex:"1 1 180px"}}>
        ...
        {/* ── STATS STRIP ── */}
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10,marginBottom:20}} className="mobile-grid1">
          {[
        ...
        {/* ── FILES SECTION ── */}
        <div style={{background:`linear-gradient(145deg,${T.surf},${T.surf2})`,borderRadius:20,border:"1px solid rgba(255,255,255,.065)",overflow:"hidden",boxShadow:"0 8px 60px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.04)"}}>
          {/* Section header */}
  ...
  return(
    <div style={{height:"100vh",display:"flex",flexDirection:"column",background:T.bg,overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"grid",gridTemplateColumns:"320px 1fr",overflow:"hidden"}}>
        {/* LEFT: Phone preview — prominent, centered, beautiful */}
