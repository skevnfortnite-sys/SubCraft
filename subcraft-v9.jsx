  ...
  return(
    <div style={{background:T.bg,minHeight:"100vh",position:"relative",overflow:"hidden"}}>
      ...
      <div ref={heroRef} id="fonctionnalités" style={{position:"relative",zIndex:1,display:"flex",alignItems:"center",padding:"60px 72px 48px",maxWidth:1400,margin:"0 auto",gap:60,minHeight:"85vh"}} className="mobile-col mobile-p">
        ...
        <div className="fu hide-mobile" style={{flexShrink:0,animationDelay:".06s",position:"relative",display:"flex",alignItems:"center",justifyContent:"center",width:520,minHeight:600}}>
          {/* Deep glow halo */}
          ...
          {/* Floating stat bubbles — more prominent, clearly outside phone */}
          <div style={{position:"absolute",top:"4%",left:"-34%",padding:"10px 16px",borderRadius:16,background:"rgba(8,10,28,.97)",border:"1px solid rgba(91,108,255,.3)",backdropFilter:"blur(20px)",boxShadow:"0 12px 40px rgba(0,0,0,.5),0 0 0 1px rgba(255,255,255,.05)",animation:"float 5s ease infinite",whiteSpace:"nowrap",zIndex:10}}>
            <div style={{fontSize:9,color:T.muted,marginBottom:3,letterSpacing:".05em",textTransform:"uppercase"}}>Générés aujourd'hui</div>
            <div className="syne" style={{fontWeight:800,fontSize:22,color:T.green,lineHeight:1}}>+2,841</div>
            <div style={{fontSize:9,color:T.muted,marginTop:3}}>sous-titres créés 🎬</div>
          </div>
          <div style={{position:"absolute",bottom:"18%",left:"-36%",padding:"10px 14px",borderRadius:16,background:"rgba(8,10,28,.97)",border:"1px solid rgba(232,57,112,.25)",backdropFilter:"blur(20px)",boxShadow:"0 12px 40px rgba(0,0,0,.5),0 0 0 1px rgba(255,255,255,.05)",animation:"float 6.5s ease infinite",animationDelay:".8s",whiteSpace:"nowrap",zIndex:10}}>
            <div style={{display:"flex",alignItems:"center",gap:9}}>
              <div style={{width:32,height:32,borderRadius:9,background:T.grad,display:"flex",alignItems:"center",justifyContent:"center",fontSize:15,flexShrink:0}}>🔥</div>
              <div>
                <div style={{fontSize:12,fontWeight:700,color:T.text}}>MrBeast Style</div>
                <div style={{fontSize:9,color:T.green,fontWeight:700}}>⭐ Style #1 populaire</div>
              </div>
            </div>
          </div>
          <div style={{position:"absolute",top:"26%",right:"-32%",padding:"10px 16px",borderRadius:16,background:"rgba(8,10,28,.97)",border:"1px solid rgba(91,108,255,.3)",backdropFilter:"blur(20px)",boxShadow:"0 12px 40px rgba(0,0,0,.5),0 0 0 1px rgba(255,255,255,.05)",animation:"float 7s ease infinite",animationDelay:"1.2s",whiteSpace:"nowrap",zIndex:10}}>
            <div style={{fontSize:9,color:T.muted,marginBottom:4,textTransform:"uppercase",letterSpacing:".05em"}}>Précision IA</div>
            <div className="syne" style={{fontWeight:800,fontSize:22,color:T.acc,lineHeight:1}}>99.2%</div>
            <div style={{height:4,borderRadius:2,background:"rgba(255,255,255,.07)",marginTop:6,overflow:"hidden",width:90}}>
              <div style={{height:"100%",width:"99%",background:`linear-gradient(90deg,${T.acc},${T.purple})`,borderRadius:2}}/>
            </div>
          </div>
          <div style={{position:"absolute",bottom:"6%",right:"-28%",padding:"9px 14px",borderRadius:14,background:"rgba(8,10,28,.97)",border:`1px solid ${T.green}35`,backdropFilter:"blur(20px)",boxShadow:"0 8px 32px rgba(0,0,0,.4)",animation:"float 4.5s ease infinite",animationDelay:"2s",whiteSpace:"nowrap",zIndex:10}}>
            <div style={{display:"flex",alignItems:"center",gap:7}}>
              <span style={{width:7,height:7,borderRadius:"50%",background:T.green,animation:"pulseDotGreen 2s infinite",flexShrink:0}}/>
              <span style={{fontSize:12,fontWeight:700,color:T.green}}>+12k créateurs actifs</span>
            </div>
          </div>
        ...
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:16,borderRight:`1px solid rgba(255,255,255,.05)`,background:"linear-gradient(180deg,#02030f,#040510)",overflowY:"auto",padding:"20px 16px",position:"relative"}} className="hide-mobile">
          ...
          <div style={{width:"100%",maxWidth:220,position:"relative",zIndex:1}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
              <span style={{fontSize:10,color:T.muted,fontWeight:600,letterSpacing:".04em"}}>POSITION SOUS-TITRES</span>
              <span style={{fontSize:10,color:T.acc,fontFamily:"JetBrains Mono",fontWeight:700}}>{subYPos}%</span>
            </div>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              <span style={{fontSize:10,color:T.dim}}>↓</span>
              <input type="range" min={4} max={80} value={subYPos} onChange={e=>setSubYPos(+e.target.value)} style={{flex:1,accentColor:T.acc,height:4,cursor:"pointer"}}/>
              <span style={{fontSize:10,color:T.dim}}>↑</span>
            </div>
          </div>
          {/* Play controls */}
