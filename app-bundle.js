    ...
    <div style={{minHeight:"100vh",background:T.bg,position:"relative"}} className="page"><AuroraBg subtle/><Cursor/>
      ...
      <nav style={{padding:"0 24px",borderBottom:"1px solid rgba(255,255,255,.05)",display:"flex",alignItems:"center",gap:10,background:"rgba(2,3,10,.88)",backdropFilter:"blur(32px)",height:62,position:"sticky",top:0,zIndex:50}}>
        ...
        <div style={{marginLeft:"auto",display:"flex",gap:6,alignItems:"center"}}>
          ...
          <Btn size="sm" onClick={()=>setPage("pricing")} style={{background:T.grad,fontSize:12,padding:"6px 12px"}}>⭐ Upgrade</Btn>
      ...
      <div style={{maxWidth:1100,margin:"0 auto",padding:"28px 24px",position:"relative",zIndex:1}}>
        ...
        <div style={{padding:"12px 16px",borderRadius:12,background:creditWarn?`${T.orange}08`:T.surf,border:`1px solid ${creditWarn?T.orange:T.border}`,marginBottom:12,display:"flex",alignItems:"center",gap:14,flexWrap:"wrap"}}>
          ...
          {creditWarn&&user?.plan!=="Pro"&&<Btn size="sm" onClick={()=>setPage("pricing")} style={{background:T.grad,flexShrink:0,fontSize:11}}>⭐ Upgrade</Btn>}
      ...
      <div style={{maxWidth:1060,margin:"0 auto",position:"relative",zIndex:1}}>
        ...
        <div style={{textAlign:"center",marginBottom:48}}>
          ...
          <div style={{display:"inline-flex",alignItems:"center",gap:16,padding:"12px 24px",borderRadius:100,background:T.surf,border:`1px solid ${T.border}`}}>
            <span style={{fontSize:14,fontWeight:yearly?400:700,color:yearly?T.muted:T.text}}>Monthly</span>
            <Tog value={yearly} onChange={setYearly}/>
            <div>
              <span style={{fontSize:14,fontWeight:yearly?700:400,color:yearly?T.text:T.muted}}>Yearly</span>
          ...
          {PLANS.map((plan,i)=>{
            ...
            return(
              <div key={plan.id} style={{borderRadius:20,padding:"28px 24px",background:plan.popular?`linear-gradient(160deg,${T.acc}12,${T.surf})`:T.surf,border:`2px solid ${plan.popular?T.acc:T.border}`,position:"relative",transition:"transform .2s",animation:`fadeUp .4s ease ${i*.08}s both`,cursor:"pointer"}}
                ...
                {plan.popular&&<div style={{position:"absolute",top:-14,left:"50%",transform:"translateX(-50%)",padding:"5px 20px",borderRadius:100,background:T.acc,color:"#fff",fontSize:12,fontWeight:800,whiteSpace:"nowrap",boxShadow:`0 4px 20px ${T.accGlow}`}}>⭐ Most popular</div>}
          ...
          <div style={{marginBottom:20}}>
            ...
            {!paypal?(
              <div style={{background:T.surf,borderRadius:14,border:`1px solid ${T.border}`,padding:20,display:"flex",flexDirection:"column",gap:14}}>
                ...
                {/* Test cards hint */}
                <div style={{padding:"10px 14px",borderRadius:8,background:`${T.acc}08`,border:`1px solid ${T.acc}18`,fontSize:11,color:T.muted}}>
                  🧪 <strong style={{color:T.text}}>Mode démo :</strong> utilise n'importe quel numéro de 16 chiffres, date future et CVC pour tester.
                </div>
              </div>
            ):(
        ...
        <div style={{background:T.surf,borderRadius:18,border:`1px solid ${T.border}`,padding:24,position:"sticky",top:20}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8,marginBottom:14}}>
            <div style={{display:"flex",justifyContent:"space-between",fontSize:13}}>
              ...
              <span>${(yearly?selectedPlan.price:selectedPlan.price).toFixed(2)}/mois</span>
            </div>
            {yearly&&savings>0&&(
              <div style={{display:"flex",justifyContent:"space-between",fontSize:13}}>
                <span style={{color:T.green}}>🎉 Réduction annuelle</span>
            ...
            <div style={{display:"flex",justifyContent:"space-between",fontSize:13}}>
              <span style={{color:T.muted}}>TVA (20%)</span>
              <span style={{color:T.muted}}>${(finalPrice*.2).toFixed(2)}</span>
            </div>
          </div>
          ...
          <div style={{display:"flex",justifyContent:"space-between",marginBottom:20}}>
            ...
            <div style={{textAlign:"right"}}>
              <div style={{fontFamily:"JetBrains Mono",fontWeight:900,fontSize:22,color:T.acc}}>${(finalPrice*1.2).toFixed(2)}</div>
              <div style={{fontSize:10,color:T.muted}}>/ mois TTC</div>
              {yearly&&<div style={{fontSize:11,color:T.green,marginTop:2}}>💰 Tu économises ${savings*12}/an</div>}
            </div>
          </div>
          {/* What you get */}
          <div style={{marginBottom:18}}>
